...
from filter_templates where table_name = 'households' and column_name like '%has_%'
UNION ALL
select id AS template_id, 'No' AS field_text, '0' AS field_value
from filter_templates where table_name = 'households' and column_name like '%has_%' ORDER BY template_id ASC;
