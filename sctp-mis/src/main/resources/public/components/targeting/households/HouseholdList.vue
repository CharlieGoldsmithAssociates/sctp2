<template>
    <div class="columns">
        <div class="column">
            <div class="box">
                <h2 class="subtitle">Household List</h2>
                <hr />
        ...
        <div class="column">
            <div class="box">
                <h2 class="subtitle">Household Members</h2>
                <hr />
                <b-table sort-icon="menu-up" :data="householdMembers" :striped="true" :narrowed="true" :hoverable="true"
                    :loading="isLoading">
