    ...
    <section>
        ...
        <div class="columns mt-3">
            ...
            <div class="column">
                <div class="columns is-vcentered">
                    <div class="column">
                        <b-image id="main-photo" :src="mainRecipientImageUrl" src-fallback="/assets/img/user-svg.svg" class="p4p obj-fit-contain" :rounded="roundedImage" alt="Main receiver photo"></b-image>
                    </div>
                ...
                <form id="mainReceiverForm" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="field">
                        ...
                        <div class="control is-expanded">
                            <img id="mainPreviewPhoto" class="preview-image obj-fit-contain is-rounded" src="/assets/img/user-svg.svg" alt="Preview image" />
                        </div>
                    </div>
                        ...
                        <div class="column mt-6">
                            ...
                            <span class="file-cta">
                              ...
                              <span class="file-label"> Select photo </span>
                                    ...
                                    <div class="level-item">
                                        <button onclick="mainPreviewPhoto.src = '/assets/img/user-svg.svg'; mainPhotoSelection.value='';" class="button is-inverted is-small is-text is-danger">
                          Cancel photo selection
                                ...
                                <div class="level-right">
                                    <div class="level-item">
                                        <button class="button is-small is-link" @click="saveMainReceiver" type="button">
                          Save changes
                        </button>
                                    </div>
                                </div>
        ...
        <div class="columns">
            ...
            <div class="column has-text-right">
                <b-button type="is-info is-link" @click="$refs.recipients.getRecipientCandidates()">
